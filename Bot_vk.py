    ...
    if event.type == VkBotEventType.MESSAGE_NEW and event.from_user:
        ...
        if text in ['привет', 'здравствуйте', 'добрый день', 'добрый вечер']:
            ...
            send_message(
                ...
                'если она не отвечает, позвонить директору Матухно Наталье Николаевне 89042015742 и сообщить о происшествии.\n'
                '2. Обратиться к врачу, вызвать скорую помощь, оформить обращение письменно.\n'
        ...
        # Обработка конкретных травм у учащихся с добавлением инструкций
            ...
            send_message(
                user_id,
                '1. Необходимо незамедлительно позвонить заместителю директора Зиновьевой Евгении Васильевне 89505654776, '
                'если она не отвечает, позвонить директору Матухно Наталье Николаевне 89042015742.\n'
                '2. Оповестить родителей (законных представителей).\n'
                '3. Вызвать скорую медицинскую помощь, если в этом есть необходимость (03, 103, 112).'
            )
            ...
            if text == 'ушиб головы':
                send_message(
                    ...
                    '2. Обеспечить покой травмированной части тела.\n'
                ...
                send_message(
                    ...
                    '1. Обеспечить покой травмированной части тела.\n'
                ...
                send_message(
                    ...
                    '1. Попросить ребенка наклонить голову вперед и приложить бинт к ноздрям.\n'
                    '2. Прижать одну ноздрю к носовой перегородке на 5-10 минут.\n'
                ...
                send_message(
                    ...
                    '4. Если ребенок не приходит в сознание в течение 3-5 минут, вызвать скорую помощь.'
                )
